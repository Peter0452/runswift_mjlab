...
Action: 16-D JointPositionAction (legs 12 + shoulder pitch/roll ×2).
  q_abs = DEFAULT + scale * a_raw
    (legs 0.8, shoulder pitch 0.12, shoulder roll 0.05 — torso_swing).
...
Default model: nubots_models/nubots_torso_swing_latest.onnx
"""
...
ACTION_DIM = 16
# Per-joint scale (mjlab torso_swing): legs 0.8, pitch 0.12, roll 0.05.
...
# Absolute shoulder q_target bands (torso_swing): pitch ±12°, roll ±7.5°.
...
DEFAULT_MODEL_PATH = _REPO_ROOT / "nubots_models" / "nubots_torso_swing_latest.onnx"
